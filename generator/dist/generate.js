...
function getAppendIndex(content) {
...
function createStyle({ displayInstructions }) {
    return `
    <style>
      :root {
      ...
      dialog.instructions {
        ...
        border-radius: 10px;
        box-shadow: 0 0 20px 0px #2c2c2c;
      ...
      dialog.instructions > details > summary {
        font-size: 1.3rem;
        cursor: pointer;
      }

      dialog.instructions > details > p {
        margin-bottom: 0;
      }

      dialog.instructions > form[method="dialog"] {
        float: right;
        width: fit-content;
      }

      dialog.instructions > form[method="dialog"] > button {
        font-size: 1.1rem;
        border-radius: 5px;
        border-width: 1.5px;
      }

      p.instructions.warning {
...
function createScript({ displayInstructions }) {
    return `
    <script>
  ...
  <body>${input.displayInstructions ? `
    <header>
      <dialog class="instructions" open>
        <h1>welcome to your folder party</h1>
        <details>
          <summary>step 1: look around, get settled ☁</summary>
          <p>all your files and furniture are here. you can drag all the items around. click on the files to view their contents.</p>
        </details>
        <details>
          <summary>step 2: arrange your space ☼</summary>
          <p>move everything where you'd like it to be for your guests. the space can be as big as you want it to be.</p>
          <p class="instructions highlight"><b>tip:</b> you can also open up the website file at any point to make changes to the html, css, and javascript code. (there's no magic! this is just a website.)</p>
        </details>
        <details>
          <summary>step 3: save your layout ⚘</summary>
          <p>press the "save" button to save a copy of this file with all adjustments. when you're ready to finalize the layout, you can save a copy without these instructions.</p>
        </details>
        <p class="instructions warning"><b>warning ⚠</b> layout adjustments are temporary until you save them. refreshing this page without saving will reset any layout adjustments you've made.</p>
