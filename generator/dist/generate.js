    ...
    <header>
      <dialog class="instructions" open>
        ...
        <details>
          ...
          <p class="instructions highlight"><b>tip ℹ</b> you can also open up the website file at any point to make changes to the html, css, and javascript code. (there's no magic! this is just a website.)</p>
        </details>
        <details>
        ...
        <p class="instructions highlight"><b>warning ⚠</b> layout adjustments are temporary until you save them. refreshing this page without saving will reset any layout adjustments you've made.</p>
